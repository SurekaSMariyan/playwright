...
const autoInjectFixtures_1 = require("./autoInjectFixtures");
...
class StepInvoker {
    ...
    async invoke(stepText, argument, stepFixtures) {
        ...
        const fixturesArg = Object.assign({}, stepFixtures, (0, autoInjectFixtures_1.getBddAutoInjectFixtures)(this.bddContext));
        ...
        await (0, runStepWithLocation_1.runStepWithLocation)(this.bddContext.test, stepTitle, location, () => stepDefinition.code(fixturesArg, ...parameters));
    }
