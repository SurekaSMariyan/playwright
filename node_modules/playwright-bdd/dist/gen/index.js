...
class TestFilesGenerator {
    ...
    async loadFeatures() {
        ...
        const featureFiles = await (0, loadFeatures_1.resolveFeatureFiles)(cwd, this.config.features);
    ...
    async loadSteps() {
        ...
        const stepFiles = await (0, load_1.resolveStepFiles)(cwd, this.config.steps);
    ...
    async handleImportTestFrom() {
        ...
        const exportedTests = await (0, load_1.loadStepsFromFile)(importTestFrom.file);
