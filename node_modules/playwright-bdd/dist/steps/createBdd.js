...
const testFixtures_1 = require("../run/testFixtures");
...
function createBdd(customTest, options) {
    if (customTest === testFixtures_1.test)
...
function assertTestHasBddFixtures(customTest) {
    if (!(0, testTypeImpl_1.isTestContainsSubtest)(customTest, testFixtures_1.test)) {
