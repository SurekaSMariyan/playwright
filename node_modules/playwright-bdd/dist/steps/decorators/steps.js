...
const autoInjectFixtures_1 = require("../../run/autoInjectFixtures");
...
function getFirstNonAutoInjectFixture(fixturesArg, stepConfig) {
    ...
    const fixtureNames = Object.keys(fixturesArg).filter((fixtureName) => !(0, autoInjectFixtures_1.isBddAutoInjectFixture)(fixtureName));
